...
qa_agent = Agent(
    ...
    backstory="You are knowledge analyst who has spent years helping people find clarity in large"
        " document collections. You are specialize in surfacing the most relevant evidence and turning it into clear,"
